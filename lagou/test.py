...
def get_district_list(url, proxies):
    my_headers = {
...
if __name__ == '__main__':
    url = 'https://www.lagou.com/jobs/list_python?px=default&gx=&isSchoolJob=1&city=%E5%8C%97%E4%BA%AC&district=%E6%9C%9D%E9%98%B3%E5%8C%BA#filterBox'
    f = open('ip.txt', 'r', encoding='utf-8')
    proxies = random.choice(f.read().split('\n'))
    get_json(url, 1, proxies)